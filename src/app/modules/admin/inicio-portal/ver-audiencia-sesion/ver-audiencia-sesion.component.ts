...
@Component({
  selector: 'app-ver-audiencia-sesion',
  standalone: true,
  ...
  templateUrl: './ver-audiencia-sesion.component.html',
})
export class VerAudienciaSesionComponent implements OnInit, OnDestroy, AfterViewInit{
    ...
    constructor(
        ...
        private _incioPortalService: InicioPortalService,
    ){
    ...
    ngOnInit(): void {
        ...
        this._incioPortalService.transcripcion$.pipe(takeUntil(this._unsubscribeAll)).subscribe((response: any) => {
    ...
    getTranscripcionPaginated(pagina: any): void {
        this._incioPortalService.getTranscripcionAudienciaPaginated(this.audiencia.clavePrincipal, pagina).pipe(takeUntil(this._unsubscribeAll)).subscribe(
            (response:any) => {
                this._incioPortalService.transcripcion = response;
    ...
    getTranscripcionBusqueda(pagina: any, data: any): void {
        this._incioPortalService.buscarEnAudienciaPaginated(this.audiencia.clavePrincipal, data, pagina).pipe(takeUntil(this._unsubscribeAll)).subscribe(
            (response:any) => {
                this._incioPortalService.transcripcion = response;
